...
.timeline-step.active .step-dot {
  ...
  border-color: #2563eb; box-shadow: 0 4px 14px rgba(37,99,235,.35);
}
.timeline-step.current .step-dot {
  background: linear-gradient(135deg, #10b981, #059669);
  border-color: #10b981; box-shadow: 0 4px 14px rgba(16,185,129,.4);
...
.product-row {
  ...
  padding: 16px 24px; border-bottom: 1.5px solid #f8faff;
