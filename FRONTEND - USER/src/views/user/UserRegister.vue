  ...
  <div class="auth-page">
    ...
    <div class="hero">
      ...
      <div class="hero-content">
        ...
        <h1 class="hero-title">Đăng ký<br/><em>thành viên</em></h1>
        <p class="hero-sub">Chỉ mất chưa đến 1 phút</p>
      </div>
    </div>
    ...
    <div class="main-panel">
      <div class="auth-card">
        ...
        <div class="field">
          ...
          <input v-model="name" class="field-input" placeholder="Nguyễn Nhựt Anh" />
        </div>
        ...
        <div class="field-row">
          <div class="field">
            ...
            <input v-model="phone" class="field-input" placeholder="0xxxxxxxxx" />
          </div>
          <div class="field">
            <label class="field-label">Ngày sinh</label>
            <input v-model="birthday" type="date" class="field-input" />
          </div>
        </div>

        <div class="field">
          <label class="field-label">Địa chỉ</label>
          <input v-model="address" class="field-input" placeholder="Số nhà, đường, quận/huyện..." />
        </div>

        <div class="field">
          <label class="field-label">Giới tính</label>
          <div class="select-wrap">
            <select v-model="gender" class="field-select">
...
.message { color: #10b981; margin-top: 14px; font-weight: 700; text-align: center; font-size: .88rem; }
